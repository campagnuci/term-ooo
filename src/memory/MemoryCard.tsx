      ...
      <div className={styles.cardInner}>
        <div className={`${styles.cardFace} ${styles.cardBack}`}>
          <svg className={styles.cardBackSeal} viewBox="0 0 60 60" aria-hidden="true">
            <circle cx="30" cy="30" r="24" fill="none" stroke="rgba(178,217,139,0.55)" strokeWidth="0.6" />
            <circle cx="30" cy="30" r="18" fill="none" stroke="rgba(178,217,139,0.4)" strokeWidth="0.4" />
            <circle cx="30" cy="30" r="12" fill="none" stroke="rgba(178,217,139,0.3)" strokeWidth="0.4" />
            <path
              d="M30 6 L33 27 L54 30 L33 33 L30 54 L27 33 L6 30 L27 27 Z"
              fill="rgba(178,217,139,0.45)"
              stroke="rgba(205,234,173,0.7)"
              strokeWidth="0.4"
            />
            <circle cx="30" cy="30" r="2.5" fill="rgba(205,234,173,0.9)" />
            <circle cx="30" cy="6" r="1" fill="rgba(178,217,139,0.7)" />
            <circle cx="30" cy="54" r="1" fill="rgba(178,217,139,0.7)" />
            <circle cx="6" cy="30" r="1" fill="rgba(178,217,139,0.7)" />
            <circle cx="54" cy="30" r="1" fill="rgba(178,217,139,0.7)" />
          </svg>
        </div>
